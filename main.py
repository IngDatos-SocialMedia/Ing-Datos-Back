...
from crypto_etl_project.src.loader.binance_loader import monitor_and_update_load
...
def extract_data_binance():
    ...
    while running:
        fetch_and_save_data()
        time.sleep(1)  # Espera 1 segundo antes de la siguiente extracción
...
def load_data_binance():
    ...
    while running:
        monitor_and_update_load(new_file_path)
        time.sleep(1)  # Espera 1 segundo antes de la siguiente carga
